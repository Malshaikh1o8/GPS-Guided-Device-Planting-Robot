...
def search(array2,v): #searcg(array[], Str V) ex: search(array9 ,"[21.7556473, 39.1477785]") ,Str v in this format "[21.7556473, 39.1477785]"
   ...
   for i in array2:
     ...
     for j in i:
        ...
        #print("For point: "+ v)
        c="X"+str(xmov*5),"Y"+str(ymov*5) #mult by 5 since each square is 5cm apart 75cm/5cm = 15 col for x axis mov 65/5=13 rows for y-axis mov 
...
while running:
    ...
    findRange(array9)
    print("example, in form of: "+ str(array9[12][9]))
    print("example, in form of: "+ str(array9[5][3]))
